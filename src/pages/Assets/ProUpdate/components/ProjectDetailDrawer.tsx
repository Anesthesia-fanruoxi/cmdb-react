  ...
  return (
    <>
      ...
      <style>{`
        ...
        .records-section h4 { margin: 0; font-size: 15px; }
        ...
        .records-table { border: 1px solid var(--border-color, #e8e8e8); border-radius: 4px; overflow: auto; max-height: 400px; }
        ...
        .records-table th { background: var(--bg-secondary, #fafafa); font-weight: 600; position: sticky; top: 0; }
        ...
        .btn-cancel, .btn-detail { padding: 2px 8px; margin: 0 2px; border: 1px solid var(--border-color, #d9d9d9); background: #fff; border-radius: 4px; cursor: pointer; font-size: 12px; }
